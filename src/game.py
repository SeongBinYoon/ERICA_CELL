...
def multigame():
    print("우여곡절 끝에 겨우 완도 근처 선착장에 도착했다.\n 무장한 군인들이 여>럿 서 있다. 다행이다….!\n어서 차에서 내려 내가 좀비가 아닌 사람이라는 것을 알려야한다.\n차오르는 기쁨에 차에서 내려 군인들에게 달려갔다.\n갑자기 군인들이 나를 향>해 총을 난사하기 시작한다.\n아마도 나를 좀비로 착각한 것 같다!\n날아오는 총을 피하기 위해 몸을 바닥으로 굴렸다.\n\n주의) !!이곳은 치료키트가 없습니다!!!")
    print()
